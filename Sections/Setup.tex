...
V_{t}(w_{t}) &=&
   ...
   & s.t. &  \nonumber
\\              w_{t+1} & = & (w_{t}-c_{t})R+y_{t+1} %%% Private CDC20190605 moved R after w-c because it is increasingly common for R to be specified as a function of (w-c) and we want to be clear that we are NOT doing that
\nonumber
\end{eqnarray*}

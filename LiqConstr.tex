\input{./econtexRoot}\input{./econtexPaths}\documentclass[titlepage]{\econtex}

\input{\ResourcesDir/owner} % Determines whether to reference llorracc or econ-ark versions

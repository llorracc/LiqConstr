...
\setboolean{verbatimwriteOn}{true}  %
...
\end{verbatimwrite}\ifVerbatimWrite{\input{Sections/PrudAndCC}}{} %

\section{Recursive Propagation of Consumption Concavity}\label{sec:Aggregation} 

\begin{verbatimwrite}{Sections/Recursive} %
...
\end{verbatimwrite}\ifVerbatimWrite{\input{Sections/Recursive}}{} %
